...
export const metadata: Metadata = { metadataBase: new URL("https://horyzon.it"), title: { default: "Horyzon Consulting — L'impresa che evolve", template: "%s — Horyzon" }, description: "Trasformiamo persone, processi e tecnologia in più risultati, più libertà e più futuro.", openGraph: { title: "Horyzon Consulting", description: "L'impresa che evolve.", images: ["/og.png"], locale: "it_IT", type: "website" }, icons: { icon: "/favicon.svg" } };
