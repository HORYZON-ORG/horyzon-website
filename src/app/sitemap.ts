...
export default function sitemap(): MetadataRoute.Sitemap {
 const routes = new Set(['', ...Object.keys(archive), ...Object.keys(pages), ...Object.keys(people), 'ai-score', 'le-tre-aree', 'metodo', 'persone', 'biblioteca', 'misura', 'radar-impresa', 'piattaforma']);
