...
export const publicFaqs: Record<string, readonly PublicFaq[]> = {
 ...
 '/piattaforma': [
  { question: 'Che cos’è Horyzon Platform?', answer: 'È la vista aziendale tenant-isolata in cui leggere KPI, report, snapshot, sincronizzazioni, Blueprint e stato delle attivazioni.' },
